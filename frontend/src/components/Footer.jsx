 ...
 * Footer Component
 * 
 * Bottom footer with app information, links, and branding.
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500">
              Empowering digital literacy through intelligent content analysis.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400 dark:text-gray-500 mb-4 md:mb-0">
              © {currentYear} VeriScope. All rights reserved.
            </div>
